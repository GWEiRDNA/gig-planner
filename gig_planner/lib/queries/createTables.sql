...
CREATE TABLE song_transitions (
    pervious_song_id bigserial NOT NULL,
    next_song_id     bigserial NOT NULL,
...
ALTER TABLE users_permisions
    ADD CONSTRAINT users_permisions_pk PRIMARY KEY ( events_id,
                                                     permissions_id,
                                                     users_id );
...
ALTER TABLE users_permisions
    ADD CONSTRAINT users_permisions_events_fk FOREIGN KEY ( events_id )
        REFERENCES events ( id );

--  ERROR: FK name length exceeds maximum allowed length(30)
ALTER TABLE users_permisions
    ADD CONSTRAINT users_permisions_permissions_fk FOREIGN KEY ( permissions_id )
        REFERENCES permissions ( id );

ALTER TABLE users_permisions
    ADD CONSTRAINT users_permisions_users_fk FOREIGN KEY ( users_id )
        REFERENCES users ( id );
